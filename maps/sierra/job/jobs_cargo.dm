/datum/job/qm
	...
	access = list(		GLOB.access_maint_tunnels, GLOB.access_emergency_storage, GLOB.access_tech_storage,  GLOB.access_cargo, GLOB.access_guppy_helm,
						GLOB.access_cargo_bot, GLOB.access_qm, GLOB.access_mailsorting, GLOB.access_expedition_shuttle, GLOB.access_guppy, GLOB.access_hangar,
						GLOB.access_mining, GLOB.access_mining_office, GLOB.access_mining_station, GLOB.access_commissary, GLOB.access_external_airlocks)
...
/datum/job/cargo_tech
	...
	access = list(GLOB.access_maint_tunnels, GLOB.access_emergency_storage, GLOB.access_cargo, GLOB.access_guppy_helm, GLOB.access_commissary,
						GLOB.access_cargo_bot, GLOB.access_mining_office, GLOB.access_mailsorting, GLOB.access_expedition_shuttle, GLOB.access_guppy, GLOB.access_hangar)
...
/datum/job/mining
	...
	access = list(GLOB.access_mining, GLOB.access_mining_office, GLOB.access_mining_station,
						GLOB.access_expedition_shuttle, GLOB.access_guppy, GLOB.access_hangar, GLOB.access_guppy_helm)
...
/datum/job/cargo_assistant
	...
	access = list(GLOB.access_maint_tunnels, GLOB.access_cargo, GLOB.access_cargo_bot, GLOB.access_mining_office, GLOB.access_mailsorting, GLOB.access_hangar, GLOB.access_guppy, GLOB.access_guppy_helm, GLOB.access_commissary)
