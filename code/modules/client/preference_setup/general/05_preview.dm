...
/datum/preferences/proc/update_preview_icon(resize_only)
	...
	if (!resize_only || !last_built_icon)
		...
		// mannequin.dir = WEST
		// last_built_icon.Blend(getFlatIcon(mannequin, WEST), ICON_OVERLAY, 1, 9)
		// CHECK_TICK
		// mannequin.dir = NORTH
		// last_built_icon.Blend(getFlatIcon(mannequin, NORTH), ICON_OVERLAY, 25, 17)
		// CHECK_TICK
		mannequin.dir = SOUTH
		last_built_icon.Blend(getFlatIcon(mannequin, SOUTH), ICON_OVERLAY, 25, 17)
