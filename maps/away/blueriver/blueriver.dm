...
/turf/simulated/floor/away/blueriver/alienfloor/Initialize(mapload, cache_turf_in_area = TRUE)
	.=..()
...
/turf/unsimulated/wall/away/blueriver/livingwall/Initialize(mapload, cache_turf_in_area = TRUE)
	.=..()
...
/turf/unsimulated/wall/supermatter/no_spread/Initialize(mapload, cache_turf_in_area = TRUE)
	.=..()
