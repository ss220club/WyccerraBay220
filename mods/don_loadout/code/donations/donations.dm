...
/singleton/modpack/don_loadout/proc/show_donations_info(mob/user)
	...
	var html = {"
	<center>Бусти проекта можно найти в разделе <b>#полезные-ссылки</b> нашего дискорда:</center>
	<br>
	<center><a href="?src=\ref[src];action=discord">Открыть Discord</a></center>
	<br>
	<center>За денежные пожертвования, в благодарность вы получаете доступ к некоторым специальным предметам лодаута (В будущем)</center>
	"}
