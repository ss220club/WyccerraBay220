...
/obj/item/card/id/awaycavalry/fleet/commander
	desc = "An identification card issued to SolGov crewmembers aboard the Sol Patrol Craft."
	icon_state = "base"
	access = list(GLOB.access_away_cavalry, GLOB.access_away_cavalry_ops, GLOB.access_away_cavalry_pilot, GLOB.access_away_cavalry_fleet_armory, GLOB.access_away_cavalry_commander) //TODO: беды с доступами
	extra_details = list("goldstripe")
