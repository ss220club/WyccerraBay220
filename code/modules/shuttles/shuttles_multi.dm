...
/datum/shuttle/autodock/multi/antag/proc/announce_departure()
	if(cloaked || isnull(departure_message))
		return
	GLOB.command_announcement.Announce(departure_message, announcer || "[GLOB.using_map.boss_name]")

/datum/shuttle/autodock/multi/antag/proc/announce_arrival()
	if(cloaked || isnull(arrival_message))
		return
	GLOB.command_announcement.Announce(arrival_message, announcer || "[GLOB.using_map.boss_name]")
