/mob/living/bot/medbot
	...
	icon_state = "medibot0"
	req_access = list(list(GLOB.access_medical, GLOB.access_robotics))
	botcard_access = list(GLOB.access_medical, GLOB.access_morgue, GLOB.access_surgery, GLOB.access_chemistry, GLOB.access_virology)
