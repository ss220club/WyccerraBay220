/datum/map/sierra
	...
	shuttle_called_message = "Внимание всему персоналу: инициирована процедура подготовки к прыжку блюспейс для перехода в следующий сектор. Расчетное время окончания зарядки генератора блюспейса: %ETA%."
	shuttle_docked_sound = sound(ANNOUNCER_BLUESPACEJUMP_INIT, volume = 45)
	shuttle_docked_message = "Внимание всему персоналу: подготовка к прыжку завершена. Инициирован запуск блюспейс двигателя. Расчетное время до начала прыжка: %ETD%."
	shuttle_leaving_message = sound(ANNOUNCER_BLUESPACEJUMP_START, volume = 45)
	shuttle_leaving_sound = "Внимание всему персоналу: запуск двигателя завершен, начат межпространственный переход. Примерное время окончания прыжка: %ETA%. Сохраняйте спокойствие и трезвость мышления."
	...
	emergency_shuttle_called_message = "Внимание всему персоналу: вступают в силу процедуры экстренной эвакуации. Будьте готовы покинуть корабль. Автоматическое подтверждение запроса через: %ETA%"
	...
	emergency_shuttle_leaving_message = "Внимание всему персоналу: активация двигателей спасательных капсул. Расчетное время прибытия до пункта встречи шлюпок: %ETA%"
	...
	grid_restored_message = "Питание корабля %STATION_NAME% успешно восстановлено из аварийного хранилища."
...
/datum/map/sierra/level_x_biohazard_announcement(bio_level)
	...
	GLOB.priority_announcement.Announce("Подтверждено наличие объекта [bio_level] уровня биологической угрозы - [msg]. [crew] персоналу требуется предпринять меры по ликвидации угрозы.", "Биоугроза", new_sound = sound)
