...
/obj/item/gun/projectile/shotgun/magshot
	...
	firemodes = list(
		list(mode_name="semi-auto",     burst=1, fire_delay=2,  one_hand_penalty=7, burst_accuracy=null, dispersion=1.5),
		list(mode_name="3 shell burst", burst=3, fire_delay=1.5,  one_hand_penalty=9, burst_accuracy=list(-1,-1, -2), dispersion=list(2, 2, 4)),
		list(mode_name="full auto",		can_autofire=TRUE, burst=1, fire_delay=1, one_hand_penalty=15, burst_accuracy = list(-1,-2,-2,-3,-3,-3,-4,-4), dispersion = list(2, 4, 4, 6, 6, 8))
		)
