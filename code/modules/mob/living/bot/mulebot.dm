...
/mob/living/bot/mulebot
	...
	target_speed = 3
	max_frustration = 5
	botcard_access = list(access_maint_tunnels, GLOB.access_mailsorting, GLOB.access_cargo, GLOB.access_cargo_bot, GLOB.access_qm, GLOB.access_mining, GLOB.access_mining_station)
