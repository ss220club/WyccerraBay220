...
/turf/simulated/proc/wet_floor(wet_val = 1, overwrite = FALSE)
	...
	timer_id = addtimer(CALLBACK(src, TYPE_PROC_REF(/turf/simulated, unwet_floor)),8 SECONDS, GLOB.TIMER_STOPPABLE|GLOB.TIMER_UNIQUE|GLOB.TIMER_NO_HASH_WAIT|GLOB.TIMER_OVERRIDE)
