/datum/map/sierra
	...
	shuttle_leaving_sound = "Внимание всему персоналу: запуск двигателя завершен, начат межпространственный прыжок. Примерное время окончания прыжка: %ETA%. Сохраняйте спокойствие и трезвость мышления."
